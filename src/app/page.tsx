        ...
        <div className="mx-auto max-w-6xl">
          <div className="grid items-center gap-12 md:grid-cols-2">
            <div data-reveal className="flex flex-col gap-6">
              <span className="text-xs font-semibold uppercase tracking-widest text-emerald-500">Quienes somos?</span>
              <h2 className="text-4xl font-bold leading-tight">
                Open source, conocimiento y <span className="gradient-text">comunidad</span>
              </h2>
              <p className="leading-relaxed text-zinc-600 dark:text-zinc-400">
                Amoxcalli es la extension Open Source de{" "}
                <a href="https://byfruits.dev" target="_blank" rel="noopener noreferrer" className="text-emerald-500 hover:underline">
                  ByFruits
                </a>
                . Mientras alla trabajamos con clientes y proyectos comerciales, aqui es nuestro compromiso con la
                comunidad: devolver lo que aprendemos, ensenar y construir juntos.
              </p>
              <p className="leading-relaxed text-zinc-600 dark:text-zinc-400">
                Somos una comunidad global de desarrolladores convencidos de que el codigo es mejor cuando se comparte.
              </p>
            ...
            <div data-reveal className="grid grid-cols-2 gap-4">
              {[
                ...
                { icon: "🚀", title: "Aprender", desc: "Nuevas tecnologias en comunidad" },
                { icon: "🤝", title: "Conectar", desc: "Con devs de todo el mundo" },
                { icon: "🌍", title: "Compartir", desc: "Best practices de produccion" },
              ].map((item) => (
      ...
      <section id="stack" data-section className="px-6 py-24">
        <div className="mx-auto max-w-6xl">
          <div data-reveal className="mb-12 flex flex-col gap-3">
            <span className="text-xs font-semibold uppercase tracking-widest text-emerald-500">Tecnologias</span>
      ...
      <section data-section className="bg-zinc-100/70 px-6 py-24 dark:bg-zinc-900/30">
        <div className="mx-auto max-w-6xl">
          <div data-reveal className="mb-12 flex flex-col gap-3">
            ...
            <h2 className="text-4xl font-bold">
              Como le <span className="gradient-text">haces</span>?
            </h2>
            <p className="max-w-xl text-zinc-600 dark:text-zinc-400">No importa tu nivel ni de donde vengas.</p>
          </div>
          ...
          <div data-reveal className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              { step: "04", icon: "💡", title: "Code", desc: "Escribe codigo limpio y documentado." },
              { step: "05", icon: "✅", title: "Test", desc: "Asegurate de que todo jale bien." },
              { step: "06", icon: "📤", title: "Pull Request", desc: "Manda tu PR con descripcion chida." },
            ].map((item) => (
        ...
        <div className="mx-auto max-w-6xl">
          <div data-reveal className="rounded-2xl border border-emerald-500/20 bg-linear-to-br from-emerald-100/70 via-white to-zinc-100 p-10 text-center md:p-16 dark:from-emerald-950/40 dark:via-zinc-900/60 dark:to-zinc-950">
            ...
            <h2 className="mb-4 text-4xl font-bold">
              Unete a la <span className="gradient-text">comunidad</span>
            </h2>
            <p className="mx-auto mb-8 max-w-lg leading-relaxed text-zinc-600 dark:text-zinc-400">
              Discussions, issues, tacos y codigo. Aqui todos somos bienvenidos.
            </p>
      ...
      <footer data-section className="border-t border-zinc-200 py-12 px-6 dark:border-zinc-800">
        <div data-reveal className="mx-auto flex max-w-6xl flex-col items-center gap-6 text-center">
          ...
          <p className="text-sm italic text-zinc-600 dark:text-zinc-400">
            "El codigo es mejor cuando se comparte" - Hecho con amor desde Mexico
          </p>
